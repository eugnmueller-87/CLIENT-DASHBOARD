...
Edit `dashboard/agent-config.yml` under `job_name: blackbox_http`:
...
2. Upload `dashboard/dashboards/agency-overview.json`
...
Rules are in `dashboard/prometheus/rules.yml`. To activate in Grafana Cloud:
